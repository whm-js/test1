<template>
  <div class="enterpage">
    ...
    <mt-popup v-model="popupVisiblePicker" position="bottom" style="width:100%;">
      ...
      <mt-picker :slots="slots" ref="pickerteacher" value-key="NameStr" @change="onValuesChange"></mt-picker>
    </mt-popup>

    <!-- <component :is="teacherTem" :teacherList="slots" :showTeacher.sync="teacherTem" :teacherName.sync="CoachingName" :teacherID.sync="CoachingID"></component> -->
...
export default {
  ...
  methods: {
    openpopup () {
      ...
      // }
      this.$refs.pickerteacher.setSlotValues(0,this.teacherArr)
    ...
    getDepartTeacher () {
      ...
      this.$httpPost("entry/getDepartTeacher", params, function (err, json) {
        if (json.status == 200) {
          ...
          // that.teacherTem = 'teacherList'
          that.teacherArr = pickerArray
  ...
  // watch:{
  //   CoachingName:function (newdata) {
  //     console.log(newdata)
  //   },
  //   CoachingID:function (newdata) {
  //     console.log(newdata)
  //   }
  // }
};
