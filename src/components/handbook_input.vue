  ...
  <div class="handbook_input">
    ...
    <div v-for="(el,n) in tabledata">
      ...
      <mt-field :label="el.text" placeholder="" v-else-if="el.type==='select'">
        <mt-radio title="" v-model="el.textValue" :options="el.option">
        </mt-radio>
      </mt-field>
    ...
    <!-- <camera :label="'拍照'" :preview="preview1"></camera> -->
    <!--<div class="mint-tabbar is-fixed">-->
      <mt-button v-if="$route.query.type!=='add'" type="primary" size="large" @click.native="camera">图片</mt-button>
      <!-- <mt-button type="primary" size="large" @click.native="upload">上传</mt-button> -->
